...
const Header = () => {
  ...
  return (
    <header className='fixed top-0 left-0 right-0 bg-gray-200 py-4 px-6 md:px-12 w-full z-50 shadow-md'>
      <div className='flex justify-between items-center h-12 max-w-5xl mx-auto'>
