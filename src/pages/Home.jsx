    ...
    <div className='min-h-screen bg-white flex flex-col'>
        ...
        <div className='w-full px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center h-16'>
            ...
            <nav className='flex ml-auto gap-20 pr-4'>
              <a href='#home' className='text-sm font-medium text-blue-600 font-semibold hover:text-blue-700 transition'>Accueil</a>
              <Link to='/student' className='text-sm font-medium text-gray-600 hover:text-blue-600 transition'>Emploi du temps</Link>
              <Link to='/login' className='text-sm font-medium text-gray-600 hover:text-blue-600 transition'>Connexion Admin</Link>
            </nav>
          </div>
        </div>
      </header>
      ...
      <section className='relative h-screen bg-cover bg-center flex items-center justify-center text-white' style={{ backgroundImage: 'url(/public/assets/bg-university.png)', backgroundAttachment: 'fixed' }}>
        ...
        <div className='relative z-10 text-center px-4 max-w-2xl'>
          <h1 className='text-6xl font-bold mb-6 leading-tight'>Système d'Emploi du Temps</h1>
          <p className='text-xl text-white/95 mb-12 font-normal leading-relaxed'>Consultez vos cours n'importe quand, n'importe où. Simple, rapide et toujours à jour.</p>
